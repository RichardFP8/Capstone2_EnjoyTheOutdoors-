        ...
        if (currentState["State"].toLowerCase() === stateSelected) {
            ...
            for (let property in currentState) {
                if (property !== "Visit") {
                    ...
                    link.innerHTML = currentState.Visit;
                    link.target = "_blank";
                    link.href = currentState[property];
...
function displayParksByType() {
    ...
    for (let i in nationalParksArray) {
        ...
        let splitParkName = currentPark.LocationName.split(" ");          //get the current park object, get the LocationName property and convert it to an array of strings  
        for (let x in splitSelectedValue) {          //each word in the selected value
            for (let y in splitParkName) {               //each word in the LocationName property
                if (splitSelectedValue[x] === splitParkName[y].toLowerCase()) {
                    ...
                    for (let property in currentPark) {
                        if (property !== "Visit") {
                            ...
                            link.target = "_blank";
                            link.href = currentPark[property];
                            cell.innerHTML = "For more information, visit\n";
                            cell.appendChild(link);
                        }
